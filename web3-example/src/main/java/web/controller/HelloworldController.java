...
public class HelloworldController {
    ...
    private static Integer startStuId=30000;
     ...
     */
    @DyGet("/{value}")
    public Integer pathValue(@DyPathVariable String value){
    ...
    public Integer insert(){
       int result= mapper.insert(new Student("s"+UUID.randomUUID(),"test"+startStuId,100));
       startStuId++;
       return result;
    }
